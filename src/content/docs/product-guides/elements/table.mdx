...
![Table Element](/docs-images/table-element-in-enveloop.png)
...
![Add a Row](/doc-images/table-add-a-row-in-enveloop.png)
...
![Add a row. Once added, you can convert it from "Text" to "Iterable".](/doc-images/table-add-iterable-row-in-enveloop.png)
...
![Assigning an object shape to an iterable row in Enveloop.](/doc-images/fill-out-iterable-table.gif)
...
![As you update test data in Enveloop, the email preview automatically updates to show you how your email will look to your users](/doc-images/table-preview-dynamic-content.png)
...
![Test Image](/doc-images/table-example-of-conditional-row-in-enveloop.png)

![A Conditional Row is another special row available in Enveloop](/doc-images/table-example-of-conditional-row-in-enveloop.png)
...
![We use the sales_tax variable as a conditional value to determine if our row that shows Sales Tax should be included in our message](/doc-images/table-use-a-conditional-row-in-enveloop.png)
